...
export class PersonalDetailsStepComponent implements OnInit {
  ...
  getPersonalDetailsEvent(): any {
    ...
    this._createEventService.getPersonalDetail(this.eventId).subscribe((result: any) => {
      if (result && result.IsSuccess) {
        ...
        // if (eventLocationObj && eventLocationObj.country_wise_contact && eventLocationObj.country_wise_contact != '') { 
        // }
  ...
  private _preparePersonalDetailsEventForm(personalDetailsObj: any = {}): void {
    this.personalDetailForm = this._formBuilder.group({
      ...
      mobile_no: [personalDetailsObj?.mobile_no || '', [Validators.required]],
      // is_mobile_hidden: [personalDetailsObj?.is_mobile_hidden || true],
      alt_mobile_no: [personalDetailsObj?.alt_mobile_no || ''],
    ...
    //   phone: new FormControl(personalDetailsObj?.country_wise_contact || undefined),
    //   alt_phone: new FormControl(personalDetailsObj?.alt_country_wise_contact || undefined),

    //   is_mobile_hidden: new FormControl(personalDetailsObj?.is_mobile_hidden || true),
    //   is_alt_mobile_hidden: new FormControl(personalDetailsObj?.is_alt_mobile_hidden || true),
    // });
